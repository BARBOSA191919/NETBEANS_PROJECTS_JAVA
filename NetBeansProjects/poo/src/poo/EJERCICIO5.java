...
public class EJERCICIO5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("7. 36°C o más");
        ...
        switch (op) {
            case 1:
                System.out.println(" la percepción de la temperatura es del DIA LUNES ;");

                break;
            case 2:
                System.out.println("la percepción de la temperatura es del DIA MARTES");

                break;
            case 3:
                System.out.println("la percepción de la temperatura es de del MIERCOLES");

                break;
            case 4:
                System.out.println("la percepción de la temperatura es del DIA JUEVES");

                break;
            case 5:
                System.out.println("la percepción de la temperatura es deL DIA VIERNES");

                break;
            case 6:
                System.out.println("la percepción de la temperatura es del DIA SABADO");

                break;
            case 7:
                System.out.println("la percepción de la temperatura es del DIA DOMINGO");
